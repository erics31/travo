...
<div class="mainwrapper">
       ...
       <div class="main-container">
          ...
          <div class="hero-grid-row">
            <div class="panel-hero">
              ...
              </div><!--image-wrapper aspect--outer-->
              <div class="img-name"><a href="">Working space</a></div><!--img-name-->
            </div><!--panel-hero-->
            ...
            <div class="panel-grid">
              <div class="hero-grid-panel">
                <div class="image-wrapper aspect--outer">
                 ...
                 <div class="img-name"><a href="">After school learning space</a></div><!--img-name-->
              </div><!--hero-grid-panel-->
               ...
               <div class="hero-grid-panel">
                <div class="image-wrapper aspect--outer">
                 ...
                 <div class="img-name"><a href="">Meeting space</a></div><!--img-name-->
              </div><!--hero-grid-panel-->
               ...
               <div class="hero-grid-panel">
                <div class="image-wrapper aspect--outer">
                 ...
                 <div class="img-name"><a href="">Renting of apartment</a></div><!--img-name-->
              </div><!--hero-grid-panel-->
               ...
               <div class="hero-grid-panel">
                <div class="image-wrapper aspect--outer">
                 ...
                 <div class="img-name"><a href="">Where can I find printer internet</a></div><!--img-name-->
              </div><!--hero-grid-panel-->
            </div><!--panel-grid-->
  ...
  <!---login popup--->
  <div class="modal fade modal-center" id="login" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!---login popup--->
    ...
    <!---signup popup--->
  <div class="modal fade modal-center" id="signup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-body">
        ...
        <form>
          <div class="rr">
            ...
            <input type="text" class="in-fld" placeholder="First name" name="">
          </div><!--row1-->
           ...
           <div class="row1">
            ...
            <input type="text" class="in-fld" placeholder="Phone number" name="">
          </div><!--row1-->
          ...
          <div class="row1 row12">
            <button class="button-log">Sign up</button>
          </div>
